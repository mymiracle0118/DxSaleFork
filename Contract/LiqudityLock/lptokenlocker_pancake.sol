...
contract LpTokenLocker {
    ...
    function lpLock(address token, uint256 amount, uint256 unlockTime, address withdrawer) payable public {
    ...
    function checkLp(address _lpToken) public view returns (bool) {
        ...
        address factoryPair = IPancakeFactory(factory).getPair(pair.token0(), pair.token1());
